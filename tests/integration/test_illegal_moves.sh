...
assert_exit_code 0
assert_stdout_contains "Status: 1"  # turn flipped to A
...
assert_exit_code 0
assert_stdout_not_contains "Status: 255"
assert_stdout_contains "Status: 1"  # still A's turn
assert_stdout_contains "Pawn Row: 0111"  # unchanged
...
assert_exit_code 0
assert_stdout_contains "Status: 2"  # B's turn now
assert_stdout_contains "Pawn Row: 0001"

# B knocks pin 3 with MOVE_1.
run_client "$PORT" "1/99/$GAME_ID/3"
assert_exit_code 0
assert_stdout_contains "Status: 4"  # WIN_B
assert_stdout_contains "Pawn Row: 0000"

echo "Test 8: After WIN, MOVE is illegal — state unchanged"
run_client "$PORT" "1/99/$GAME_ID/0"
assert_exit_code 0
assert_stdout_not_contains "Status: 255"
assert_stdout_contains "Status: 4"  # still WIN_B
assert_stdout_contains "Pawn Row: 0000"
