...
assert_exit_code 0
assert_stdout_contains "Status: player A's turn"  # turn flipped to A
assert_stdout_contains "Pawns: \.###"
...
assert_exit_code 0
assert_stdout_not_contains "Server rejected the message"
assert_stdout_contains "Status: player A's turn"  # still A's turn
assert_stdout_contains "Pawns: \.###"  # unchanged
...
assert_exit_code 0
assert_stdout_contains "Status: player B's turn"  # B's turn now
assert_stdout_contains "Pawns: \.\.\.#"
...
assert_exit_code 0
assert_stdout_not_contains "Server rejected the message"
assert_stdout_contains "Status: player B wins"  # still WIN_B
assert_stdout_contains "Pawns: \.\.\.\."
