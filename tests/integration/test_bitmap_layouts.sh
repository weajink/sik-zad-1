...
run_client "$PORT" "0/1"
assert_exit_code 0
assert_stdout_contains "Max Pawn: 0"
...
assert_stdout_contains "Status: 2"        # still B's turn
assert_stdout_contains "Pawn Row: 1"      # pin still there (or "10000000" — be tolerant)
...
run_client "$PORT" "0/1"
assert_stdout_contains "Max Pawn: 4"
...
run_client "$PORT" "0/1"
assert_exit_code 0
assert_stdout_contains "Max Pawn: 255"
